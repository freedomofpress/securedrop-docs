...
![screenshot_sdapp_main_view](../images/screenshot_sdapp_main_view.png)
...
![screenshot_send_reply](../images/screenshot_send_reply.png)

:::{note}
If a reply fails to be sent successfully, it will still be visible in subsequent sessions, including to any other users logging into the same physical SecureDrop Workstation.
:::
...
![screenshot_delete_sources_select](../images/screenshot_delete_sources_select.png)
...
![screenshot_confirm_delete](../images/screenshot_delete_sources_dialog.png)
