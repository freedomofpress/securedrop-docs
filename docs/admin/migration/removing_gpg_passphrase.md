...
In a `dom0` terminal on your Qubes workstation (![Qubes Application menu](../../images/qubes_menu.png) **▸** ![System Tools](../../images/qubes_menu_gear.png) **▸ Other ▸ Xfce Terminal**), assuming a passphrase-protected secret key file `/tmp/sd-journalist.sec`, import the key into a new temporary GnuPG directory, entering the passphrase when prompted:
