...
7. The firewall uses a self-signed certificate, so you will see a "Potential Security Risk Ahead" warning when you connect. This is expected. You can safely continue by clicking **Advanced**, then **Accept the Risk and Continue**.
   ...
   ![Your Connection is Insecure](../../images/firewall/your_connection_is_insecure.png)

8. You should see the login page for the pfSense GUI. Log in with the default username and passphrase (`admin` / `pfsense`).

   ![Default pfSense](../../images/firewall/default_pfsense.png)
...
![Alternate Hostnames](../../images/firewall/alternate_hostnames.png)
...
2. On the "General Information" page, we recommend leaving your hostname as the default (pfSense). There is no relevant domain for SecureDrop, so we recommend setting this to `securedrop.local` or something similar. Use your preferred DNS servers. If you don't know what DNS servers to use, we recommend using Google's DNS servers: `8.8.8.8` and `8.8.4.4`. Click Next.
   ...
   ![pfSense General Info](../../images/firewall/pfsense_general_information.png)
...
5. For "Configure LAN Interface", use the IP address of the *Admin Gateway* (`10.20.1.1`) and the subnet mask (`/24`) of the *Admin Subnet*. Click **Next**.
   ...
   ![Configure LAN Interface](../../images/firewall/configure_lan_interface.png)
...
![Ping](../../images/firewall/pfsense_diagnostics_ping.png)
...
![Disable DHCP](../../images/firewall/disable_DHCP.png)

(assign_static_ip_to_workstation)=
...
![Blank IP Aliases](../../images/firewall/pfsense_blank_ip_aliases.png)
...
![Add Firewall Alias](../../images/firewall/add_firewall_alias.png)

Click **Save** to add the alias.

Keep adding aliases until the screenshot matches what is shown here:

![Firewall IP Aliases Pre Save](../../images/firewall/ip_aliases_pre_save.png)
...
![Firewall IP Aliases Post Save](../../images/firewall/ip_aliases_post_save.png)
...
![Port Aliases](../../images/firewall/port_aliases.png)
...
![Firewall LAN2 Rules](../../images/firewall/lan2_firewall_rules.png)

**LAN3 interface:**

![Firewall LAN3 Rules](../../images/firewall/lan3_firewall_rules.png)
...
![Firewall Update Confirmation](../../images/firewall/system_update.png)

You will see a page with a progress bar while pfSense performs the upgrade:

![Firewall Update Progress](../../images/firewall/system_is_updating.png)
...
![Firewall Update Complete](../../images/firewall/system_update_complete.png)
...
[intentionally disables lan access]: https://gitlab.tails.boum.org/tails/tails/-/issues/7976
