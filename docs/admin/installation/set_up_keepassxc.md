...
Qubes OS comes with the KeePassXC password manager preinstalled. As outlined in our [passphrase best practices](#passphrase_best_practices), we recommend all SecureDrop users, including Administrator, use the KeePassXC password manager to generate and retain strong and unique passphrases.
...
(keepasscx_template_database)=

- Open the KeePassXC program ![KeePassXC](../../images/keepassxc.png) in the `vault` qube
...
(keepassxc_manual_create_database)=
