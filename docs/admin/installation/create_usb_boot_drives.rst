...
24.04.4 LTS (Noble Numbat)**. To install Ubuntu on the servers, you must first
...
* `ubuntu-24.04.4-live-server-amd64.iso`_
* `SHA256SUMS`_
* `SHA256SUMS.gpg`_
...
.. code:: sh
   ...
   cd ~/Downloads
   curl -OOO https://releases.ubuntu.com/24.04.4/{ubuntu-24.04.4-live-server-amd64.iso,SHA256SUMS{,.gpg}}

.. _Ubuntu Releases page: https://releases.ubuntu.com/
.. _ubuntu-24.04.4-live-server-amd64.iso: https://releases.ubuntu.com/24.04/ubuntu-24.04.4-live-server-amd64.iso
...
The next and final step is to verify the Ubuntu image. ::
    ...
    sha256sum -c <(grep ubuntu-24.04.4-live-server-amd64.iso SHA256SUMS)
