...
The SecureDrop *Application Server* and *Monitor Server* run **Ubuntu 24.04.4 LTS (Noble Numbat)**. To install Ubuntu on the servers, you must first
...
than the one that ships by default in **Ubuntu Server 24.04.4** in order to have
