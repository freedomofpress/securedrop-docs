...
* - Server certificate not verified
  - :::{line-block}
    Check that the relay certificate is valid (for more detailed help, see [Troubleshooting SMTP TLS](#troubleshooting-smtp-tls)). Consider adding `smtp_relay_cert_override_file`
