...
2. Connect the Admin Workstation to the LAN interface. You should see a popup notification in Tails that says "Connection Established". If you click on the network icon in the upper right of the Tails Desktop, you should see that the "Wired Connection" is active:
   ...
   ![Wired Connected](../../images/firewall/wired_connected.png)
...
7. The firewall uses a self-signed certificate, so you will see a "This Connection Is Untrusted" warning when you connect. This is expected. You can safely continue by clicking **Advanced** and **Accept the Risk and Continue**.
   ...
   ![OPNSense - Your Connection is Insecure](../../images/opnsense/opnsense-insecure.png)

8. You should see the login page for the OPNSense GUI. Log in with the default username and passphrase (`root` / `opnsense`).

   ![OPNSENSE - Default Login](../../images/opnsense/opnsense-login.png)
...
> ![OPNSense - alternate hostnames](../../images/opnsense/opnsense-alternate-hostname.png)
...
1. **General Information**: Leave your hostname as the default, `OPNsense`. There is no relevant domain for SecureDrop, so we recommend setting this to `securedrop.local` or something similar. Use your preferred DNS servers. If you don't know what DNS servers to use, we recommend using Google's DNS servers: `8.8.8.8` and `8.8.4.4`. Uncheck the **Override DNS** checkbox.
   ...
   ![OPNSense General Info](../../images/opnsense/opnsense-wizard-general.png)
...
4. **Configure LAN Interface**: Use the IP address of the *Admin Gateway* (`10.20.1.1`) and the subnet mask (`/24`) of the *Admin Subnet*. Click **Next**.
   ...
   ![OPNSense: Configure LAN Interface](../../images/opnsense/opnsense-configure-lan.png)
...
![OPNSense - No Updates](../../images/opnsense/opnsense-no-updates.png)
...
![OPNSense - auth server](../../images/opnsense/opnsense-authservers.png)
...
![OPNSense - otpcheck](../../images/opnsense/opnsense-otpcheck.png)
...
![OPNSense - qrscan](../../images/opnsense/opnsense-qrcode.png)
...
![OPNSense - testuserhappy](../../images/opnsense/opnsense-testuserhappy.png)
...
> ![OPNSense - totp server](../../images/opnsense/opnsense-totpserver.png)
...
![OPNSense - Disable DHCP](../../images/opnsense/opnsense-disable-dhcp.png)
...
![Wired Settings](../../images/firewall/wired_settings.png)
...
![4 NIC Admin Workstation Static IP Configuration](../../images/firewall/four_nic_admin_workstation_static_ip_configuration.png)
...
![OPNSense - assign interfaces](../../images/opnsense/opnsense-assign-interfaces.png)
...
![OPNSense - Alias Start](../../images/opnsense/opnsense-alias-start.png)
...
![OPNSense - aliases end](../../images/opnsense/opnsense-alias-end.png)
...
![OPNSense - Firewall LAN Rules](../../images/opnsense/opnsense-lan-rules.png)
...
![OPNSense - Disable Antilockout](../../images/opnsense/opnsense-antilockout.png)
...
![OPNSense Firewall OPT1 Rules](../../images/opnsense/opnsense-firewall-opt1.png)
...
![OPNSense Firewall OPT2 Rules](../../images/opnsense/opnsense-firewall-opt2.png)

Finally, click **Apply Changes**.

The *Network Firewall* configuration is now complete, allowing you to move to the next step: [setting up the servers.](prepare_servers.md)
...
If you see that an update is available, we recommend installing it. Most of these updates are for minor bugfixes, but occasionally they can contain important security fixes. You should keep apprised of updates yourself by checking the [OPNSense Blog](https://opnsense.org/blog/) or subscribing to the [OPNSense Blog RSS feed](https://opnsense.org/blog/rss).
