...
Onion names are short, memorable addresses that visitors can use to access an [Onion Service](#glossary_onion_service) (e.g., a news organization's SecureDrop) using Tor Browser.
...
If your SecureDrop instance is not part of the directory yet, you can [begin the process here](#the-securedrop-directory). In order to be eligible for inclusion, your SecureDrop and its associated clearnet Landing Page must be set up consistent with the best practices recommended in our documentation.

If you are already part of the SecureDrop directory and would like a short onion name, [please contact us.](#getting-support)
