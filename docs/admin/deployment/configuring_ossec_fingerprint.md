...
Specifying the fingerprint will configure Postfix to use it for verification on the next playbook run. To apply the configuration, use `securedrop-admin` to [update the server configuration](#update-system-configuration).
