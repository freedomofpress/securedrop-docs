...
These instructions should work for many recent laptops, including the two ThinkPad models specifically included in our [](../installation/hardware.md).
...
- Visit [https://support.lenovo.com](https://support.lenovo.com) in the Linux-based computer. Type the machine type found above into the search bar, then press **Enter**.
