...
[The latest SecureDrop Inbox and Workstation version numbers are available at securedrop.org.](https://securedrop.org/)
...
:alt: A screenshot of the preflight update window, displaying a failed update error
:  message. The title reads "Security updates failed", and the message instructs the
:  user to contact the Administrator to correct the error. SecureDrop Inbox cannot
...
1. Open a terminal in `dom0` via ![Qubes Application menu](../../images/qubes_menu.png) **▸ Gear Icon (left-hand side) ▸ Other Tools ▸ Xfce Terminal**.
...
01. **Start a terminal** in the `work` qube via the menu: ![Qubes Application menu](../../images/qubes_menu.png) **▸ Apps ▸ work ▸ Xfce Terminal**
...
03. **Verify the expiry is 2027-05-24:**
...
05. **Print the exported key's checksum:**
...
06. **Start a dom0 terminal** via ![Qubes Application menu](../../images/qubes_menu.png) **▸** ![System Tools](../../images/qubes_menu_gear.png) **▸ Other Tools ▸ Xfce Terminal**.

    The remaining commands will all be executed in this dom0 terminal.

07. **Copy the key into dom0:**
...
08. **Verify the key checksum matches:**
