...
In the course of normal administration operations you should not need to view messages from Sources, but if you do, you can find information on managing submissions in
...
upper right corner of the Admin Interface.
...
Source Interface and Admin Interface. By default, it's set to ``SecureDrop``.
...
were previously uploaded will still be available via the Admin Interface.
