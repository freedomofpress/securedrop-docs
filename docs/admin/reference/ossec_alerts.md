...
This alert is common but if you see them for sustained periods of time (several times a day), please [contact us](/introduction/getting_support.md) for help.
...
If you have any suggestions on how to further tune or improve the alerting, you can open an issue on [GitHub](https://github.com/freedomofpress/securedrop/labels/goals%3A%20reduce%20IDS%20noise).
...
To resolve the issue, you can [clean them up](#submission-cleanup).
...
Alternatively, the error text may say: `The iptables rules have not been configured.` To resolve the issue, you can reinstate the standard iptables rules by [updating the system configuration](#update-system-configuration).
...
If you believe that the system is behaving abnormally, you should [contact us](/introduction/getting_support.md) for help.
