...
SecureDrop version 2.14.0 equips SecureDrop to communicate with our new App on the SecureDrop Workstation. This change will `simplify SecureDrop for journalists while safeguarding whistleblowers' anonymity against evolving threats <https://securedrop.org/news/looking-back-at-2025/>`_.

For more details, see the `announcement for this release <https://securedrop.org/news/securedrop-2_14_0-released/>`_.

Update Workstations to SecureDrop 2.14.0
----------------------------------------
...
Update to SecureDrop 2.14.0 using the graphical updater
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Perform the update to 2.14.0 by clicking "Update Now":
...
.. important:: If you do see the warning "refname '2.14.0' is ambiguous" in the
