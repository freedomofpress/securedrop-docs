...
Obtain a new USB drive and instal Tails 7 on it. The `Tails website <https://tails.net/>`__ has detailed and
...
- **3.2.** At the Tails welcome screen, select your language and keyboard layout, if needed, and then click "Start Tails".
...
- **3.6.** Once the process is complete, you can close the Tails Cloner and remove the newly-upgraded-to-Tails-7 *Admin* or *Journalist Workstation* USB drive. Be careful not to accidentally remove the *Tails 7 USB* that was used to boot the computer. 
