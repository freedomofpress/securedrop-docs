...
SecureDrop version 2.15.0 enables the V2 API to support the `upcoming SecureDrop Inbox <https://securedrop.org/news/securedrop-inbox-is-coming/>`_.
...
Update to SecureDrop 2.15.0 using the graphical updater
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Perform the update to 2.15.0 by clicking "Update Now":
...
.. important:: If you do see the warning "refname '2.15.0' is ambiguous" in the
