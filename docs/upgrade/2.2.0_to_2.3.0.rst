...
Perform the update to 2.3.0 by clicking "Update Now":
...
.. important:: If you do see the warning "refname '2.3.0' is ambiguous" in the
...
------------------------------------
SecureDrop 2.2.x was the last release series with support for Mac Mini
