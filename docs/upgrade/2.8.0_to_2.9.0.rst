...
.. note::
    SecureDrop 2.9.0 provides the option to enable Tor Proof-of-Work
    defenses for the *Source Interface* to protect against network attacks.
    
    This will be enabled automatically for new installations, but existing
    installations will require this feature to be manually enabled.
    
    To enable Tor proof-of-work defenses, please refer to
    :doc:`our guide here. <../admin/deployment/tor_pow>`
