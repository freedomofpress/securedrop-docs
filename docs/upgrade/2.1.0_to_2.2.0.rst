...
hardware. If you are still using Mac Mini servers, you must move to a
:ref:`supported hardware <Specific Hardware Recommendations>` platform as soon
as possible to continue using SecureDrop.
