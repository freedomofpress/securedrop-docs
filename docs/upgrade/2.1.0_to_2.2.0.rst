...
Mac Mini Deprecation
--------------------
The SecureDrop 2.2.x series will be the last regular releases of SecureDrop
with support for Mac Mini hardware. If you are still using Mac Mini servers,
you must move to a :ref:`supported hardware <Specific Hardware Recommendations>`
platform as soon as possible to continue using SecureDrop.
