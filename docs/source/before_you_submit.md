...
If the two addresses don't match, please do not submit to this organization yet. Instead, please [contact us](https://securedrop.org/report-an-error) through the SecureDrop website, using Tor Browser. For additional security, you can use our onion address in Tor:
...
[@gettor_bot on telegram]: https://t.me/gettor_bot
[securedrop directory]: https://securedrop.org/directory
[tails operating system]: https://tails.net/
[tor project's website]: https://www.torproject.org/
