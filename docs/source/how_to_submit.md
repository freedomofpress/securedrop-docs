...
![Example home page of a SecureDrop instance.](../images/manual/screenshots/source-index.png)
...
![Warning banner: Your Tor Browser's Security Level is too low.](../images/manual/securedrop-security-slider-warning.png)
...
![Example home page displaying instructions to increase Tor Browser's Security Level.](../images/manual/security-slider-high.png)
...
![Advanced Security Settings in Tor Browser.](../images/manual/source-turn-slider-to-high.png)
...
![Example welcome page displaying a codename.](../images/manual/screenshots/source-generate.png)
...
![Example submission page, where documents and messages can be submitted.](../images/manual/screenshots/source-submission_entered_text.png)
...
![Example submission page, displaying a confirmation message after a submission was sent successfully.](../images/manual/screenshots/source-lookup.png)
...
![Page displaying instructions to clear your Tor Browser session by resetting your identity.](../images/manual/screenshots/source-logout_new_identity.png)
...
![Dialog box asking for confirmation before Tor Browser is restarted.](../images/manual/restart-tor-browser.png)
