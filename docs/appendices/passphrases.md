...
The Administrator will be using an Admin Workstation configured to connect to the Application Server and the Monitor Server using Tor and SSH. The tasks performed by the Administrator will require the following set of credentials and passphrases:
...
The Journalist will be using a SecureDrop Workstation to view messages and files sent to their SecureDrop instance. The tasks performed by the Journalist will require the following set of passphrases:
...
If your organization is not using a password manager already, please see the [Freedom of the Press Foundation guide](https://freedom.press/training/blog/choosing-password-manager/) to choosing one.
...
2. If necessary, **do** write your passphrase down temporarily while you memorize it.
   ...
   :::{caution}
   **Do** store your written passphrase in a safe place, such as a safe at home or on a piece of paper in your wallet. **Do** destroy the paper as soon as you feel comfortable that you have
...
![screenshot of KeePassXC passphrase generation feature, showing a randomly generated 7-word passphrase](../images/screenshots/keepassxc-diceware.png)
