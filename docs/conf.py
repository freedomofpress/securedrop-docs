...
# MyST (Markdown) parser options. See
# https://myst-parser.readthedocs.io/en/latest/syntax/optional.html
myst_enable_extensions = [
    # {style=lower-alpha} on the one lettered list
    "attrs_block",
    # ::: fences, for directives nested inside list items
    "colon_fence",
    # definition lists
    "deflist",
    # {{ version }} below
...
exclude_patterns = ["_build", "includes", "diagrams"]
